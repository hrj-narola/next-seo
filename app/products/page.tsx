                    ...
                    <div className="mx-auto flex max-w-7xl items-center justify-between">
                        ...
                        <nav>
                            <ul className="flex gap-4 text-sm font-medium text-neutral-600 dark:text-neutral-400">
                                ...
                                <li>
                                    <a href="/products" className="text-neutral-900 dark:text-white">
                                        Products
                                    </a>
                                </li>
                                <li>
                    ...
                    <section aria-labelledby="products-heading">
                        <div className="mb-8 text-center sm:text-left">
                            ...
                            <p className="mt-4 max-w-2xl text-lg text-neutral-600 dark:text-neutral-400">
                                This page is statically generated (SSG). The product list is fetched at build time and served instantly.
                            </p>
                        </div>
