				...
				<main className="mx-auto max-w-7xl">
					...
					<article className="grid gap-8 overflow-hidden rounded-2xl bg-white p-6 shadow-sm dark:bg-neutral-900 lg:grid-cols-2 lg:p-12">
						...
						<div className="flex flex-col justify-center">
							<div className="mb-4">
								<span className="inline-block rounded-full bg-blue-50 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-blue-700 dark:bg-blue-900/30 dark:text-blue-500">
									{product.category}
								</span>
							</div>
							...
							<div className="mb-6 flex items-center gap-4">
								...
								<span className="text-sm text-neutral-500 dark:text-neutral-400">({product.rating.count} reviews)</span>
							</div>
